...
const IndexOld = httpVueLoader('/public/new/pages/index_test.vue');
const IndexCart = httpVueLoader('/public/new/pages/index_cart.vue');
...
const CheckoutPage = httpVueLoader('/public/new/pages/checkout.vue');
const CheckoutErrorPage = httpVueLoader('/public/new/pages/checkout_error.vue');
const FreeCard = httpVueLoader('/public/new/pages/free_card.vue');
const CartPage = httpVueLoader('/public/new/pages/cart.vue');
...
const routes = [
    ...
    {path: '/home', component: IndexOld, name: "Home 2"},
    {path: '/compra/:token', component: CheckoutPage, name: "Checkout"},
    {path: '/error/payment/:ordenId', component: CheckoutErrorPage, name: "Errorpage"},
    ...
    {path: '/gratis', component: FreeCard, name: "Regala una tarjeta"},
    {path: '/carrito', component: CartPage, name: "Carrito de compra"},
    {path: '/hometest', component: IndexCart, name: "Home cart"}
];
